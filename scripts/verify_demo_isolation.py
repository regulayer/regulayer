...
# CONTROL_URL = "http://control-plane:8000"
...
def test_demo_isolation():
    ...
    # Use the SaaS entry point which enforces Gateway Mode (and Auth)
    # Using /v1/decisions (legacy/proxy) might bypass Auth or hit Recorder directly.
