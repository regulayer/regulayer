        ...
        <footer className="relative overflow-x-clip">
            ...
            <div className="relative">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pt-20 pb-4">
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 mb-16">
                        <div className="max-w-xs">
                            ...
                            <p className="text-base leading-relaxed tracking-wide mt-2 font-medium" style={{ color: "hsl(15,30%,40%)" }}>
                                The complete cryptographic governance layer. <br />
                                Seamless proof for every AI inference.
                            </p>
                        </div>
                    ...
                    {/* Massive brand text */}
                    <div className="w-full flex justify-center mt-8 lg:mt-12 pointer-events-none relative z-0 overflow-visible">
                        <motion.div
                            initial={{ opacity: 0, y: 100, scale: 0.95 }}
                            whileInView={{ opacity: 1, y: 0, scale: 1 }}
                            viewport={{ once: true, margin: "50px" }}
                            transition={{ type: "spring", stiffness: 60, damping: 20 }}
                            className="text-[clamp(4rem,12vw,11rem)] font-bold tracking-[-0.04em] select-none overflow-visible block" 
                            style={{ 
