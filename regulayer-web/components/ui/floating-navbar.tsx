    ...
    return (
        <AnimatePresence mode="wait">
            ...
            >
                ...
                <button className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-slate-900 px-4 py-2 rounded-full">
                    <span>Login</span>
                    <span className="absolute inset-x-0 w-1/2 mx-auto -bottom-px bg-gradient-to-r from-transparent -zinc-500 to-transparent  h-px" />
                </button>
            </motion.div>
        </AnimatePresence>
    );
