    ...
    return (
        <div className="max-w-3xl mx-auto py-16 px-6">
            ...
            <div className="prose prose-slate max-w-none text-slate-600">
                ...
                <p>Welcome to Regulayer. This document outlines the Terms of Service governing your use of our cryptographic trust layer and associated APIs.</p>
                ...
                <p>For any inquiries regarding this Terms of Service, please contact our legal team at legal@regulayer.tech or our Data Protection Officer at dpo@regulayer.tech.</p>
            </div>
        </div>
    );
}